...
/***/ function(module, exports, __webpack_require__) {
	...
	var _loginSession = __webpack_require__(217);
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        'div',
	        null,
	        this.props.location.pathname === "/dashboard" ? _react2.default.createElement(_navbar2.default, null) : _react2.default.createElement('nav', null),
	...
	(0, _reactDom.render)(_react2.default.createElement(
	  ...
	  _react2.default.createElement(
	    ...
	    _react2.default.createElement(_reactRouter.Route, { path: 'login', component: _loginSession2.default }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Logo = React.createClass({
		...
		render: function render() {
			return React.createElement('img', { src: 'imgs/washington-department-of-health.svg', className: 'img-responsive img-responsive--center logo' });
		}
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _tinyTiles = __webpack_require__(223);

	var _tinyTiles2 = _interopRequireDefault(_tinyTiles);
	...
	var LoginSession = _react2.default.createClass({
		displayName: 'LoginSession',
		...
		render: function render() {
			...
			return _react2.default.createElement(
				'form',
				{ onSubmit: this.handleSubmit, className: 'container login' },
				this.state.loggedIn ? _react2.default.createElement(
					'div',
					null,
					_react2.default.createElement('img', { src: 'imgs/login/watcard.jpg', className: 'login__profile-picture img-circle' }),
					_react2.default.createElement(
						'h3',
						{ className: 'login__profile-name' },
						'Qile Wang'
					),
					_react2.default.createElement(
						'p',
						{ className: 'login__profile-email' },
						'Qile@aroundthelines.com'
					)
				) : _react2.default.createElement(
					'div',
					{ className: 'input-group login__input login__input--email' },
					_react2.default.createElement(
						'span',
						{ className: 'login__input__icon input-group-addon', id: 'sizing-addon1', htmlFor: 'email' },
						_react2.default.createElement('img', { src: 'imgs/login/group-2.svg', className: 'login__input__icon__image' })
					),
					_react2.default.createElement('input', { required: true, name: 'email', ref: 'email', type: 'email', placeholder: 'EMAIL', className: 'form-control login__input__field', 'aria-describedby': 'sizing-addon1' })
				),
				_react2.default.createElement(
					'div',
					{ className: 'input-group login__input' },
					_react2.default.createElement(
						'span',
						{ className: 'login__input__icon input-group-addon', id: 'sizing-addon2', htmlFor: 'email' },
						_react2.default.createElement('img', { src: 'imgs/login/group.svg', className: 'login__input__icon__image' })
					),
					_react2.default.createElement('input', { required: true, name: 'password', ref: 'password', type: 'password', placeholder: 'PASSWORD', className: 'form-control login__input__field', 'aria-describedby': 'sizing-addon2' })
				),
				_react2.default.createElement(
					'div',
					_defineProperty({ className: 'form-group' }, 'className', 'login__submit'),
					_react2.default.createElement(
						'button',
						{ className: 'btn btn-primary login__submit__button', type: 'submit' },
						'SIGN IN'
					),
					_react2.default.createElement('br', null),
					_react2.default.createElement(
						'a',
						{ href: '#', className: 'login__submit__help' },
						'Need help?'
					)
				),
				this.state.loggedIn ? _react2.default.createElement(_tinyTiles2.default, null) : _react2.default.createElement('div', null)
			);
		}
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Tile = __webpack_require__(220);
	...
	var Dashboard = React.createClass({
		...
		render: function render() {
			return React.createElement(
				'div',
				{ className: 'container apps' },
				React.createElement(Tile, { img: 'imgs/apps/1-1.svg' }),
				React.createElement(Tile, { img: 'imgs/apps/1-2.svg' }),
				React.createElement(Tile, { img: 'imgs/apps/1-2.svg' }),
				React.createElement(Tile, { img: 'imgs/apps/1-1.svg' }),
				React.createElement(Tile, { img: 'imgs/apps/1-2.svg' }),
				React.createElement(Tile, { img: 'imgs/apps/1-2.svg' }),
				...
				React.createElement(
					...
					React.createElement(
						...
						React.createElement(
							...
							React.createElement('img', { src: this.props.img, className: 'tile__content__img-responsive' })
						)
					)
				)
			);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Navbar = React.createClass({
		...
		render: function render() {
			return React.createElement(
				'div',
				{ className: 'container-fluid pull-right navbar' },
				React.createElement(
					'a',
					{ href: '/' },
					React.createElement('img', { src: 'imgs/nav/help.svg', className: 'navbar__icon' })
				),
				React.createElement(
					'a',
					{ href: '/' },
					React.createElement('img', { src: 'imgs/nav/notifications.svg', className: 'navbar__icon' })
				),
				React.createElement(
					'a',
					{ href: '/' },
					React.createElement('img', { src: 'imgs/nav/apps.svg', className: 'navbar__icon' })
				),
				React.createElement(
					'a',
					{ href: '/' },
					React.createElement('img', { src: 'imgs/login/watcard.jpg', className: 'img-circle navbar__profile' })
				)
			);
		}
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TinyTiles = _react2.default.createClass({
		displayName: "TinyTiles",
		render: function render() {
			return _react2.default.createElement(
				"div",
				{ className: "container container--tiny" },
				_react2.default.createElement("img", { src: "imgs/apps/1-1.svg", className: "tiny" }),
				_react2.default.createElement("img", { src: "imgs/apps/1-2.svg", className: "tiny" }),
				_react2.default.createElement("img", { src: "imgs/apps/1-1.svg", className: "tiny" }),
				_react2.default.createElement("img", { src: "imgs/apps/1-2.svg", className: "tiny" }),
				_react2.default.createElement("img", { src: "imgs/apps/1-1.svg", className: "tiny" }),
				_react2.default.createElement("img", { src: "imgs/apps/1-2.svg", className: "tiny" }),
